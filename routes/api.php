...
Route::namespace('Api')->group(function() {
    ...
    Route::group(['middleware' => 'auth:sanctum'], function () {
        ...
        //users
        Route::get('users/{user}/re-invite', 'UserController@reInvite');
        Route::post('users/{user}/notify', 'UserController@sendNotification');
        ...
        //category-services
        Route::post('category-services/sort', 'CategoryServicesController@sort');
